...
def label(text):
    ...
    st.markdown(f'<div style="font-family:DM Mono,monospace;font-size:0.58rem;letter-spacing:0.14em;text-transform:uppercase;color:#6A6A64;margin-bottom:4px;margin-top:16px">{text}</div>', unsafe_allow_html=True)
